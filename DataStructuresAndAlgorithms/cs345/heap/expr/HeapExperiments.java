...
public class HeapExperiments {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            pq = new NaivePriorityQueue<Integer>(array2It(vals), compInt);
            while (! pq.isEmpty())
                pq.extractMax();
            aft = System.nanoTime();
            npqResults += aft-fore;
            ...
            fore = System.nanoTime();
            pq = new SortedPriorityQueue<Integer>(array2It(vals), compInt);
            while (! pq.isEmpty())
                pq.extractMax();
            aft = System.nanoTime();
            spqResults += aft-fore;
        ...
        for (int i = 0; i < 5; i++) {
            ...
            pq = new NaivePriorityQueue<Integer>(size, compInt);
            fore = System.nanoTime();
            ...
            pq = new SortedPriorityQueue<Integer>(size, compInt);
            fore = System.nanoTime();
            for (int j = 0; j < size; j+=2) {
                pq.insert(vals[j]);
                pq.insert(vals[j+1]);
