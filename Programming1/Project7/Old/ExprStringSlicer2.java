...
public class ExprStringSlicer2 {
	...
	public static int getFirstOp(String s, String op1, String op2,
	...
	public static int noOpTimes(String s, ArrayList<int[]> parenIndexes) {
		int r = -1;
	...
	public static Boolean isValidInput(String s) {
		...
		if (nopen != nclosed) isValid = false;

		return isValid;
	}

	public static int[] findVars(String s) {
		int nVars = 0;
		for (int i = 0; i < s.length(); i++) {
	...
	public static void main(String args[]) {
		System.out.println(slice(args[0])[0]);
		System.out.println("Hello " + slice(args[0])[0] + " " + slice(args[0])[1] + " " + slice(args[0])[2]);
	}
}