...
int quickSortR(int array[], int start, int stop)
{
  ...
  int temp = array[stop - 1];
  array[stop - 1] = array[i];
  array[i] = temp;

  compars += quickSortR(array, start, i);
  compars += quickSortR(array, i + 1, stop);
...
int mergeSortR(int array[], int helper[], int start, int stop)
{
