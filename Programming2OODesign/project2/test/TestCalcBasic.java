...
public class TestCalcBasic extends TestCalcAbs {
    ...
    public void doubleDecimal() {
        testSequence("12.7.9", new String[] {"12.79"});
    }
    ...
    public void doubleNegative() {
        testSequence(CalculatorFace.PLUS_MINUS + "15" + CalculatorFace.PLUS_MINUS, new String[] {"15"});
    }
    
    @Test
    public void noEquals() {
        testSequence("1+2", new String[] {"2"});
    }
